...
PICS = (environ.get('PICS', 'https://telegra.ph/file/be86d66923a150c1191a6.jpg')).split() #SAMPLE PIC
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002136490979')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bestanimeandcartoonsclips:VrMTuRFUEZdKsoV7@cluster0.ayqz3o3.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "bestanimeandcartoonsclips")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Arya_Movies_Request_Group') # Support Chat Link Without https:// or @
